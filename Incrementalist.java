...
/**
 * Dumb AI that picks the highest-scoring one-tile move. Plays a two-tile move on the first turn. Exchanges all of its letters if it can't find any other move.
 */
public class Incrementalist implements ScrabbleAI {
    ...
    /**
     * Technically this tries to make a two-letter word by playing one tile; it won't find words that simply add a tile to the end of an existing word.
     */
